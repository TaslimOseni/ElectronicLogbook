package com.dabinu.app.electroniclogbook.utils;

/**
 * Created by Taslim Oseni on 2/20/19.
 */
public class Constants{
    ...
    public static final String DEFAULT_FILL = "default";
    public static final String FILLED = "true";
    public static final String NOT_FILLED = "false";
